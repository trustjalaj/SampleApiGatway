package io.jalaj.application.repository;

import io.jalaj.application.ApiGatwayJhipsterApp;
import io.jalaj.application.config.Constants;
import io.jalaj.application.config.audit.AuditEventConverter;
import io.jalaj.application.domain.PersistentAuditEvent;
...
import static io.jalaj.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
